...
const contracts = Object.freeze({
  ...
  scaffold: contract(
    ...
    "storybook init reads the required non-empty package.json#label and creates .storybook data without a manifest label, plus optional runtime/story owner directories. Project/workspace composition requires explicit --declaration paths and never scans directories.",
