...
const contracts = Object.freeze({
  ...
  catalog: contract(
    ...
    "const project = {workspaces: [\"packages/*\", \"!packages/excluded\"]}\n// A package is selectable without .storybook/manifest.json\n// numeric/index.ts: category @packageDocumentation\n// numeric/number/index.ts: component @packageDocumentation\n// numeric/number/src/number.tsx: implementation; discovery stops here\n// exports and re-exports do not classify category or component\nconst subject = {\n  id: \"number\",\n  kind: \"component\",\n  label: \"Number\",\n  apiName: \"NumberParameter\",\n  directory: \"numeric/number\",\n  route: \"parameters/number\",\n  presentation: {\n    protocol: \"story-presentation/1\",\n    projection: \"display\",\n    widgets: [\"source\", \"diagnostics\"],\n  },\n  variants: [{\n    id: \"field\",\n    label: \"Field\",\n    route: \"parameters/number/field\",\n    module: {path: \"./stories/number.ts\", export: \"field\"},\n  }],\n}\n// A single binding gives number one row with its TSDoc and authored variants\n// Multiple Socket preset subjects stay below the socket module row\n// src/, shared/, .storybook/, tests/ and test/ are hidden at every depth\n// .gitignore excludes dist/; build/ remains visible unless ignored",
  ),
  workbench: contract(
