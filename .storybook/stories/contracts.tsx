...
const contracts = Object.freeze({
  ...
  scaffold: contract(
    ...
    "storybook init creates .storybook data and optional runtime/story owner directories. Project/workspace composition requires explicit --declaration paths and never scans directories.",
