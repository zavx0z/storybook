...
const contracts = Object.freeze({
  ...
  typeContract: contract(
    ...
    "Нормативные источники — requirements.md#contract-documentation и requirements.md#documentation-standard. Файлы contract/input.ts и contract/output.ts создают одну вкладку Контракт после Зависимостей; отсутствующий раздел не показывается. README объясняет работу пакета, а TSDoc документирует существующие интерфейсы и функции рядом с кодом.",
