...
Структурное обнаружение директорий, TSDoc и spec/deps.spec.ts дополняет тот же
контракт, сохраняя один реестр, Workbench и MCP. Другие виды spec ещё не подключены.
