...
Физический Display имеет постоянные атрибуты `width=600`, `height=337.5` в мм,
CSS-разрешение `2268 × 1276 px` и `scale: 1`. Плотность `dpi` вычисляется
по обеим осям. По границам свободной области HUD host рассчитывает
