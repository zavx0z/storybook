...
Снимок содержит состояние нового запуска, затем его исходы и проверки.
Компонент отображается только после успешного выполнения теста, с проверенными props.
