...
[readScenario](../../../archetypes/specs/scenarios/index.ts) читает структуру исходника, выполняет его настоящим
...
```ts
await readScenario({
  path: "/проект/archetypes/package/spec/scenario.spec.ts",
