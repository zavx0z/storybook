...
принадлежат [README Package](package/README.md). Этот README сохраняет правила
...
- [Создание и оформление пакетов](package/README.md)
...
[Идентичность и состав пакетов](package/README.md#package-identity).

[Обзор пакета и его обнаружение](package/README.md#package-readme).
...
цикл, границы и карту ответственности. Назначение README пакета описано в [правиле обзора](package/README.md#package-readme).
...
корнями без изменения деклараций. Название пакета определяется [правилами metadata](package/README.md#package-identity).
...
[Публичные входы пакета и экспорт контрактных типов](package/README.md#package-exports).
...
[Обнаружение и независимость пакетов](package/README.md#package-discovery).

[Границы пакета и владение ресурсами](package/README.md#package-ownership).
