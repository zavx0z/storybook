...
[Идентичность и состав пакетов](package/index.ts#package-identity).

[Обзор пакета и его обнаружение](package/index.ts#package-readme).
...
цикл, границы и карту ответственности. Назначение README пакета описано в [правиле обзора](package/index.ts#package-readme).
...
корнями без изменения деклараций. Название пакета определяется [правилами metadata](package/index.ts#package-identity).
...
[Публичные входы пакета и экспорт контрактных типов](package/index.ts#package-exports).
...
[Обнаружение и независимость пакетов](package/index.ts#package-discovery).

[Границы пакета и владение ресурсами](package/index.ts#package-ownership).
