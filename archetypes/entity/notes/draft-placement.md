...
Далее также описано, как Storybook обходил эти директории и показывал их;
эти детали обнаружения нужно сверять с текущей реализацией.
...
## Связь с готовыми представлениями
