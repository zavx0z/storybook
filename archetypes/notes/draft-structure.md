...
Обзор пакета читается из начального TSDoc его index. README сохраняет указатели
по [жизненному циклу заметок](note-lifecycle.md) и не подставляется в обзор.
