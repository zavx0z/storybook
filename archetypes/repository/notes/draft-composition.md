...
Удаление не изменяет репозиторий. Вложенный пакет исключается из композиции
подключённых корней с сохранением соседей. Повторное добавление не создаёт дубликат.
