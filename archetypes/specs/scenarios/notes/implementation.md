...
- [validate.ts](../src/validate.ts) применяет реализованные правила и обозначает незавершённые проверки.
- [index.ts](../index.ts) объединяет структуру, один запуск и валидацию в публичный результат.
