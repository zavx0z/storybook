...
На каждом уровне объекта отдельный пункт «Ключи» показывает полный состав
полей через `toEqual` с ожидаемыми видами значений. Ниже каждый вложенный
объект или массив раскрывается категорией, а конечные значения — тестами.
