...
Репозиторий и самостоятельный пакет должны содержать `README.md` рядом
с `package.json`: назначение, ответственность и основные точки входа.
...
Изменение обзора репозитория не требует сборки пакетов; обзор пакета входит
в его ревизию и обновляется в пользовательских вкладках после применения.
